  ...
  return (
    <LegalPage
      ...
      body={[
        ...
        "Puedes conocer, actualizar o suprimir tus datos escribiendo a angeljoyasyesmeraldas@gmail.com. El consentimiento del newsletter es independiente de la compra.",
