  ...
  return (
    <CartProvider>
      ...
      <a
        ...
        className="fixed bottom-5 right-5 z-40 flex h-12 w-12 items-center justify-center rounded-full bg-gold-500 text-ink shadow-gold transition hover:bg-gold-300"
      >
